...
import Bold from "../../../../editor/toolbar/icons/bold";

describe("Bold Icon component", () => {
  test("Renders Bold icon with correct color", () => {
    const TEST_COLOR = "red";
    const { container } = render(<Bold color={TEST_COLOR} />);
