...
import Paragraph from "../../../../editor/toolbar/icons/paragraph";

describe("Paragraph Icon component", () => {
  test("Renders Paragraph icon with correct color", () => {
    const TEST_COLOR = "red";
    const { container } = render(<Paragraph color={TEST_COLOR} />);
